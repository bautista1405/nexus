          ...
          <SimpleGrid
            ...
            <Stack>
              ...
              <Stack direction={'row'} spacing={6}>
                <SocialButton label={'Twitter'} href={'https://twitter.com/nexus_lat'}>
                  <FaTwitter />
                </SocialButton>
                <SocialButton label={'LinkedIn'} href={'https://www.linkedin.com/company/nexus-lat/about/'}>
                  <Icon as={BsLinkedin} />
                </SocialButton>
                <SocialButton label={'Telegram'} href={'https://t.me/nexus_lat'}>
                  <Icon as={FaTelegram} />
                </SocialButton>
              </Stack>
            </Stack>
            <Stack align={'flex-start'} pt={20} color='#e9ecef'>
              ...
              <Button onClick={onOpen} variant='link' color='#e9ecef' fontWeight={400}>Contact us</Button>
              <Link href={'/#pricing'}>Pricing</Link>
              
            </Stack>
            {/* <Stack align={'flex-start'} pt={20} color='#e9ecef'>
              
              <Text color='#c77dff' fontSize={20}>Support</Text>
            ...
            <Stack align={'flex-start'} pt={20} color='#e9ecef'>
              <ListHeader>Want a word?</ListHeader>
              <Stack direction={'row'}>
